                ...
                <div class="container-fluid h-custom">
                  <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-9 col-lg-6 col-xl-5">
                      <img src="imagenes/ho123-removebg-preview.png" style="width: 1000px;"
                        class="img-fluid" alt="Sample image">
                    </div>
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                      <form>
                        <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                          <h1 class="display-12 fw-bolder text-dark mb-2">Registrate ahora</h1>
              
                        </div>
              
                        <div class="divider d-flex align-items-center my-4">
                          <p class="text-center fw-bold mx-3 mb-0">Es rapido y facil</p>
                        </div>
              
                        <!-- Email input -->
                        <div class="form-outline mb-4">
                          <input type="nombre" id="form3Example3" class="form-control form-control-lg"
                            placeholder="Ingresa tu nombre completo" />
                          <label class="form-label fw-bold" for="form3Example3">Nombre</label>
                        </div>

                         <!-- Email input -->
                         <div class="form-outline mb-4">
                          <input type="apellido" id="form3Example3" class="form-control form-control-lg"
                            placeholder="Ingresa tu apellido" />
                          <label class="form-label fw-bold" for="form3Example3">Apellido</label>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <label class="form-label fw-bold" for="form3Example3">Correo Electronico</label>
                          </div>

                          <!-- Email input -->
                        <div class="form-outline mb-4">
                          <input type="email2" id="form3Example3" class="form-control form-control-lg"
                            placeholder="Verificar correo electronico" />
                          <label class="form-label fw-bold" for="form3Example3">Verifica</label>
                        </div>
                        ...
                        <div class="form-outline mb-3">
                          ...
                          <label class="form-label fw-bold" for="form3Example4">Contraseña</label>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <a href="login.php" class="chat-square-text-fill" >Completar</a>
                        </div>
