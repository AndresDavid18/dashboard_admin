...
$(function() {
	...
	$(".my-login-validation").submit(function(event) {
		...
		if (form[0].checkValidity() === false) {
		  ...
		  // Agregar la redirección a otra página aquí
		  window.location.href = "http://localhost/dashboard_admin/vistas/index.php"; // Reemplaza la URL con la que deseas redirigir
		}
